...
function makeAJAXCall(methodType,url,callback,async=true,data=null)
{
    ...
    //eventlistener will keep getting calls on state change.
    //this is event listener and it'll be always called whenever there is change in status of xhr.
    ...
    xhr.onreadystatechange = function(){
        ...
        if(xhr.readyState == 4)
        {
            ...
            {
                //using callback function, i'm able to reuse code
                //otherwise i'll have to make ajax call method for each request
                callback(xhr.responseText);
            }
            //if status is greater than 4000, there is error in calling request
...
const emplData = {"name":"Amit","salary":"14500"};
